...
We use a few key metrics in this analysis: AUC, precision, recall, and accuracy. Here is a quick discussion on each:
- AUC: Area under ROC curve represents the probability that the model ranks a random positive example higher than a random negative example
